              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php echo form_open(base_url().'produksi/daging','class="form-horizontal form-data"', array("id" => "form-data"));?>
                    ...
                    <p class="card-title mt-4">
                      Daging Kerbau / <i>Buffalo Meat</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                    ...
                    <p class="card-title mt-4">
                      Daging Kuda/Lainnya / <i>Horse Meat/Other</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                    ...
                    <p class="card-title mt-4">
                      Daging Ayam Buras / <i>Lokal Chicken Meat</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                    ...
                    <p class="card-title mt-4">
                      Jeroan semua jenis (termasuk lidah sapi) / <i>Offal All Kinds</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
