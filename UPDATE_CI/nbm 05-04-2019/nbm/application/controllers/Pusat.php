...
class Pusat extends CI_Controller
{
  ...
  function padi()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/padi/index');
    $this->load->view('templates/footer');
    }
  ...
  function berpati()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/berpati/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function gula()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/gula/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function biji()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/biji/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function buah()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/buah/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function sayur()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/sayur/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function daging()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/daging/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function telur()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/telur/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function susu()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/susu/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function ikan()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/ikan/index');
    $this->load->view('templates/footer');
    }
  }
  ...
  function minyak()
  {
    ...
    $this->load->view('templates/header',$data);
    $this->load->view('templates/topnav'); 
    $this->template->load('templates','pusat/produksi/minyak/index');
    $this->load->view('templates/footer');
    }
  }
