              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h4>
                   ...
                   <?php echo form_open(base_url().'admin/berpati_post_impor','class="form-horizontal form-data"', array("id" => "form-data"));?>
                   <div class="row">
                     <div class="col-md-4">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          <div class="col-sm-12">
                            ...
                            <input type="text" id="angka_impor[]" name="angka_impor[]" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
