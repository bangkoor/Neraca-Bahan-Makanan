<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php echo form_open(base_url().'produksi/berpati','class="form-horizontal form-data"', array("id" => "form-data"));?>
                    <p class="card-title mt-4">
                      Ubi jalar / <i>Sweet potatoes</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                    ...
                    <p class="card-title mt-4">
                      Ubi kayu/Gaplek / <i>Cassava/Manioc</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                    ...
                    <p class="card-title mt-4">
                      ...
                      Ubi kayu/Tapioka / <i>Cassava/Tapioca</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                    ...
                    <p class="card-title mt-4">
                      Sagu/Tepung sagu / <i>Sago pith/Sago flour</i>
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                    ...
                    <p class="card-title mt-4"> 
                      ...
                      Umbi-umbian lainnya (Talas, Yam, Labu Parang dan <i>butternut</i> dll) 
                    </p>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
